                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                >
                                                    <i
                                                        class="flex-shrink-0 bx bx-credit-card me-2 pe-1"
                                                    ></i>
                                                    <span
                        ...
                        <footer class="content-footer footer bg-footer-theme" v-if="store.get_token">
                            ...
                            >
                                ...
                                <div class="d-none d-lg-inline-block">
                                    ...
                                    >
                                    <a
                                        href="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/documentation/laravel-introduction.html"
                                        target="_blank"
                                        class="footer-link me-4"
                                        >Documentation</a
                                    >
